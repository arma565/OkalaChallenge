...
namespace OkalaChallenge.Data.Models.OpenWeather.Weather
{
    public class WeatherMain
    {
        ...
        public double FeelsLike { get => _feelsLike; set => _feelsLike = value; }
        ...
        public int SeaLevel { get => _seaLevel; set => _seaLevel = value; }
        [JsonPropertyName("grnd_level")]
        public int GrndLevel { get => _grndLevel; set => _grndLevel = value; }
    }
}